@echo off
echo ========================================
echo Quick Switch to Port 3308
echo ========================================
echo.

echo Switching database configuration to port 3308...
echo.
...
echo Running quick switch to port 3308...
echo.
...
echo.
echo Successfully switched to port 3308!
echo.
pause 